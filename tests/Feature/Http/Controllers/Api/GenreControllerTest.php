...
class GenreControllerTest extends TestCase
{
    ...
    public function testStore()
    {
        ...
        $response = $this->assertStore($data + ['categories_id' => [$categoryId]], $data + ['active' => true, 'deleted_at' => null]);
        ...
        $this->assertStore($data + ['categories_id' => [$categoryId]], $data + ['deleted_at' => null]);
    }
    ...
    public function testUpdate()
    {
        ...
        $this->assertUpdate($data + ['categories_id' => [$categoryId]], array_merge($data, ['active' => false]));
    }
